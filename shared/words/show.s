...
#======================================================================
#======================================================================
# transpiling User/fth-words/show.f on 2024/11/13 06:46:35
# 
# :~ show.xt? ( ffa -- )
#     @ $fff and case
...
SHOWDOTXTQ_0013: # else
	...
	.word XT_OVER
	.word XT_EQUAL
	.word XT_DOCONDBRANCH,SHOWDOTXTQ_0015 /* if */
	.word XT_DROP
	STRING "DEFER   "
	.word XT_DOBRANCH,SHOWDOTXTQ_0016
SHOWDOTXTQ_0015: # else
	.word XT_TO_R
	STRING "UNKNOWN "
	.word XT_R_FROM
	.word XT_DROP
SHOWDOTXTQ_0016: # then
